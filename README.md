# It-Crowd modification

## Support for Organization runners

This forked version of https://github.com/machulav/ec2-github-runner adds support for organization runners.
...
`desired-runners`                                                                                                                                                            | Optional. Used with `start` and `stop` mode.    | This number is used to determinate the number of runners that will be created. <br><br> If no number is specified then it will create only one instance.                                                                                                                      |
